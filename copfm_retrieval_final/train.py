...
def main(config_path):
    ...
    for epoch in range(config['training']['epochs']):
        ...
        #         e_a = model.get_retrieval_embedding(img_a, wl_a, bw_a, mode='cross', meta_info=meta_a)
        #         e_b = model.get_retrieval_embedding(img_b, wl_b, bw_b, mode='cross', meta_info=meta_b)
